...
const cases = [
  {
    ...
    usability: {
      style: 'findings',
      intro: 'We ran a usability study with 28 participants on our high-fidelity prototype, focusing on three core task flows.',
      findings: [
        {
          icon: '🗺️',
          title: 'Map Readability',
          observed: 'Users struggled to distinguish food locations from gate markers.',
          fixed: 'Increased icon contrast and added color-coded categories.',
        },
        {
          icon: '⏱️',
          title: 'Menu Clarity',
          observed: 'Participants missed the estimated pickup time entirely.',
          fixed: 'Moved it to a persistent badge on each item card.',
        },
        {
          icon: '✋',
          title: 'Accessibility',
          observed: 'Touch targets on the collapsible flight panel were too small for one-handed use.',
          fixed: 'Enlarged tap zones and added a swipe gesture.',
        },
      ],
    },
